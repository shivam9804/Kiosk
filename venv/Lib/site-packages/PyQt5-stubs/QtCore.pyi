...
class QAbstractItemModel(QObject):
    ...
    dataChanged: pyqtSignal  # fix issue #5
...
class QAbstractTableModel(QAbstractItemModel):
    ...
    def sibling(self, row: int, column: int, idx: QModelIndex) -> QModelIndex: ...
    def parent(self) -> QObject: ...  # type: ignore  # fix issue #1
    def flags(self, index: QModelIndex) -> Qt.ItemFlags: ...
    def dropMimeData(self, data: 'QMimeData', action: Qt.DropAction, row: int, column: int, parent: QModelIndex) -> bool: ...
    def index(self, row: int, column: int, parent: QModelIndex = ...) -> QModelIndex: ...
...
class QFile(QFileDevice):
    ...
    @typing.overload  # type: ignore  # fixes issues #1
    def resize(self, sz: int) -> bool: ...
    @typing.overload
    @staticmethod
...
class QIdentityProxyModel(QAbstractProxyModel):
    ...
    def dropMimeData(self, data: 'QMimeData', action: Qt.DropAction, row: int, column: int, parent: QModelIndex) -> bool: ...
    def rowCount(self, parent: QModelIndex = ...) -> int: ...
    def parent(self, child: QModelIndex) -> QModelIndex: ...  # type: ignore  # fix issue #1
    def mapToSource(self, proxyIndex: QModelIndex) -> QModelIndex: ...
    def mapFromSource(self, sourceIndex: QModelIndex) -> QModelIndex: ...
    def index(self, row: int, column: int, parent: QModelIndex = ...) -> QModelIndex: ...
    def columnCount(self, parent: QModelIndex = ...) -> int: ...
...
class QSignalMapper(QObject):
    ...
    mapped: pyqtSignal  # fixes issue #5
...
class QStringListModel(QAbstractListModel):
    ...
    def flags(self, index: QModelIndex) -> Qt.ItemFlags: ...
    def setData(self, index: QModelIndex, value: typing.Any, role: int = ...) -> bool: ...
    def data(self, index: QModelIndex, role: int) -> typing.Any: ...  # type: ignore  # fix issue #1
    def rowCount(self, parent: QModelIndex = ...) -> int: ...
...
class QTimer(QObject):
    ...
    timeout: pyqtSignal  # fix issue #5
...
def pyqtSlot(*types: typing.Any, name: typing.Optional[str] = ..., result: typing.Optional[str] = ...) -> typing.Callable[[FuncT], FuncT]: ...  # fix issue #6
def QT_TRANSLATE_NOOP(a0: str, a1: str) -> str: ...
def QT_TR_NOOP_UTF8(a0: str) -> str: ...
def QT_TR_NOOP(a0: str) -> str: ...
def Q_FLAGS(*a0: typing.Any) -> None: ...  # fix issue #6
def Q_FLAG(a0: typing.Union[type, enum.Enum]) -> None: ...
def Q_ENUMS(*a0: typing.Any) -> None: ...  # fix issue #6
